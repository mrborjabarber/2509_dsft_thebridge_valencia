...
Se realizarán por grupos mezclados de la vertical de Data Science y Full Stack, divididos en grupos. Cada grupo deberá crear un repositorio de Github para subir el desarrollo final.
...
4. **Creación de la Base de Datos**: Utilizando un sistema de gestión de bases de datos de PostgreSQL, crear la base de datos y las tablas necesarias según el modelo lógico.

5. Crear las queries necesarias para crear las tablas e ingestar los datos. 

6. (Extra Opcional) Alojar en algún servidor vuestras bases de datos para poder acceder desde aplicaciones de terceros.
   
servicio gratis de postgreSQL:
...
**Fecha entrega** : Viernes 31 de Octubre a las 9:00. Se realizará una presentación técnica (formato libre) por grupos Se deberá mostrar la base de datos ingestada según la solución propuesta y una serie de queries de consulta como demo de funcionamiento de la base de datos.
